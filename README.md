...
- Важное правило: "один аккаунт - одно подключение".
  То есть, при необходимости можно использовать несколько аккаунтов на устройствах для управления роботом (телефон, планшет, HomeAssistant).
- Только один аккаунт будет выступать в качестве основного ("Master"), к которому необходимо выполнить привязку робота.
- Для управления роботом с других устройств, необходимо предоставить доступ к роботу с основного аккаунта (в терминах приложения - "Поделиться устройством").
